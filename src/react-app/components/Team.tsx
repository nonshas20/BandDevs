...
function AnimatedTechIcons({ darkMode }: AnimatedTechIconsProps) {
  ...
  const techIcons = [
    ...
    { name: 'Azure', url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azure/azure-original.svg', color: '#0078D4' },
    { name: 'GCP', url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/googlecloud/googlecloud-original.svg', color: '#4285F4' },
    { name: '.NET', url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg', color: '#512BD4' },
  ...
  const secondRow = techIcons.slice(10, 19);
